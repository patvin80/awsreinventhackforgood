...
This is a sample template for vibrant - Below is a brief explanation of what we have generated for you:
...
```bash
aws s3 mb s3://awshackathonreinvent2019team41 --profile reinventhack
```
...
sam package \
    ...
    --s3-bucket awshackathonreinvent2019team41 \
    --profile reinventhack
```
...
aws cloudformation describe-stacks \
    --stack-name vibrant --query 'Stacks[].Outputs'
```
